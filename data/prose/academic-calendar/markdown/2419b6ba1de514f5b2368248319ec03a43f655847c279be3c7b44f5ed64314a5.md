...
First\-day orientation program for all students registered in the programs listed below\. On the first day of Winter Term 1, all classes are replaced by the [Imagine UBC Day](http://students.ubc.ca/campus/get-oriented) with the single exception of those classes that start at or after 5:00 pm and meet only once per week\.
